          ...
          child: Column(
            ...
            children: [
              ClipRRect(
                ...
                child: Image.asset(
                  'lib/images/Card5.png', // Replace with the actual image path
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  bulletPoint('Implement Remote Work Policies'),
                  bulletPoint('Host/Join Digital Meetings'),
                  bulletPoint('Engage in Paperless Operations'),
                  bulletPoint('Indulge in Virtual Events'),
                  bulletPoint('Participate in an eco-friendly campaign'),
                  bulletPoint('Employee Sustainabilty Education'),
                  bulletPoint('Join a Green NGO'),
